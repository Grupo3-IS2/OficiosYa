...
export default function PersonalDataSection({ value, onChange, onSave, message }: {
    value: PersonalData; onChange: Dispatch<SetStateAction<PersonalData>>; onSave: () => Promise<boolean>; message?: string
}) {
