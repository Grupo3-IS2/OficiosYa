...
export default function PersonalDataSection({ value, onChange, onPhotoChange, onSave, message, error, emailChanged, currentPassword, onCurrentPasswordChange, showPhone, emailEditable = true }: {
